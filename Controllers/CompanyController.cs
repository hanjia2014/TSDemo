...
namespace TSDemo.Controllers
{
    public class CompanyController : ApiController
    {
        public IEnumerable<Company> Get()
        {
            ...
            return new List<Company> { new Company { Id = 1, Name = "Company A", Address = "Wellington", Employees = datacomEmployees }, new Company { Id = 2, Name = "Company B", Address = "Auckland", Employees = trademeEmployees } };
        }
    }
}
